const obj = {
  ...
  const {name:objName,address,address:{city:MyCity,pincode,locality:{landmark}}} = obj;
  
  console.log(objName,MyCity,landmark,address,pincode);
...
let saleProducts = arr.filter(function(element){
    return !element.isSale
})
